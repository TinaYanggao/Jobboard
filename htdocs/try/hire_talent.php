...
.btn-create-job { background-color:#032D84; color:#FEFE; border:2px solid #032D84; }
...
<form method="POST" class="mt-2 d-flex align-items-center">
    ...
    <button type="submit" name="update_status" class="btn btn-create-job btn-sm">Update</button>
</form>
</div>
<?php endwhile; ?>
<?php else: ?>
...
<div class="mb-3"><label>Title</label><input type="text" class="form-control" name="title" id="jobTitle" required></div>
<div class="mb-3"><label>Description</label><textarea class="form-control" name="description" id="jobDescription" rows="3" required></textarea></div>
<div class="mb-3"><label>Requirements</label><textarea class="form-control" name="requirements" id="jobRequirements" rows="2"></textarea></div>
<div class="mb-3"><label>Salary</label><input type="text" class="form-control" name="salary" id="jobSalary"></div>
<div class="mb-3"><label>Location</label><input type="text" class="form-control" name="location" id="jobLocation"></div>
<div class="mb-3"><label>Employment Type</label>
<select class="form-control" name="employment_type" id="jobEmployment">
...
<div class="mb-3"><label>Contact Name</label><input type="text" class="form-control" name="contact_name" id="jobContactName"></div>
<div class="mb-3"><label>Contact Email</label><input type="email" class="form-control" name="contact_email" id="jobContactEmail"></div>
<div class="mb-3"><label>Contact Phone</label><input type="text" class="form-control" name="contact_phone" id="jobContactPhone"></div>
</div>
